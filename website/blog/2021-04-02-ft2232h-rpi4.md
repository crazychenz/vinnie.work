...
- [Dockerfile](2021-04-02-ft2232h-rpi4/Dockerfile) - The primary Dockerfile
- [build.sh](2021-04-02-ft2232h-rpi4/build.sh) - A script for running the build.
- [ftdi_env.sh](2021-04-02-ft2232h-rpi4/ftdi_env.sh) - A template script for running a temporary container.
...
![Wiring Diagram](2021-04-02-ft2232h-rpi4/rpi4-to-ft2232h-wiring.png)
