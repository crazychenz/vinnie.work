...
![broken usb-c raspberry pi 4](./rpi4-broken-usbc.jpg)
...
![usbc breakout board](./usbc-breakout-small.jpg)
...
![usb-c connector pinouts](./usb-c-pinouts.jpg)
...
![top view](./design-top-view.jpg)

Side View:

![side view](./design-side-view.jpg)
...
![bad solder joint](./solder-joints.jpg)

Here is an image of the whole USB-C from RPi4 to breakout:

![bad solder joint](./solder-joint-top.jpg)
...
![usb-c test points](./usb-c-test-points.jpg)
...
![rig top view](./rig-top-view.jpg)

Rear View:

![rig top view](./rig-rear-view.jpg)

Perspective View:

![rig perspective view](./rig-perspective-view.jpg)
