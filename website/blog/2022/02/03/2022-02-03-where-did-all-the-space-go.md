...
![treeview bad cluster size](./treeview-bad-alloc.png)

![projects in exfat](./projects-in-exfat.png)
...
![disk management projects visual representation](./diskmgr-projects.png)

After doing this, I grabbed a screen grab of the `Properties` of my new VHDX drive:

![projects in vhdx](./projects-in-vhdx.png)
