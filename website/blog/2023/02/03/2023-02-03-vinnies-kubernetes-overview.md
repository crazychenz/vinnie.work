...
![k8s-resource-relationship-diagram](./k8s-resource-relationship.png)
...
![deploy yaml image](./deploy-yaml.png)
...
![service yaml image](./service-yaml.png)
...
![ingress yaml image](./ingress-yaml.png)
...
![volume yaml image](./volume-yaml.png)
...
![config yaml image](./config-yaml.png)
...
![secret yaml image](./secret-yaml.png)
