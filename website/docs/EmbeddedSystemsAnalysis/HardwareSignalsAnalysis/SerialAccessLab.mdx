...
<details>
<summary>Click to compare baud and bits per second (bps).</summary>
<br />
...
<details>
<summary>Click to see an example setup.</summary>
<br />
...
<details>
<summary>Click to see video demonstration.</summary>
...
<details>
<summary>See information about issues with `-bash: /dev/ttyUSB1: Permission denied`</summary>
<br />
...
<details>
<summary>Click to see and example bash script.</summary>
<br />
