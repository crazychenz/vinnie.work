...
if (MDXP_MODE === 'onepage') {
  cfg = {
    output: {
      path: path.resolve(__dirname, `dist/${process.env.DECK}/onepage`),
      filename: 'main.js',
      publicPath: './'
    },
    babel: {
  ...
  cfg = {
    output: {
      path: path.resolve(__dirname, `dist/${process.env.DECK}/web`),
      filename: 'main.js',
...
// Main Config
module.exports = {
  entry: `./decks/${process.env.DECK}/index.jsx`,
  output: cfg.output,
  ...
  plugins: [
    ...
    new HtmlWebPackPlugin({
      template: path.resolve(__dirname, `./decks/${process.env.DECK}/index.html`),
      filename: './index.html'
    }),
